...
class CThostFtdcTraderSpi {
 public:
  ...
  /// 请求核心间资金转移响应
  virtual void OnRspTransFund(CThostFtdcTransFundField *pTransFund,
                              CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                              bool bIsLast){};
  ...
  /// 请求查询合约状态响应
  virtual void OnRspQryInstrumentStatus(
  ...
  /// 期权自对冲录入错误回报
  virtual void OnErrRtnOptionSelfCloseInsert(
      CThostFtdcInputOptionSelfCloseField *pInputOptionSelfClose,
      CThostFtdcRspInfoField *pRspInfo){};
...
class TRADER_API_DLL_EXPORT CThostFtdcTraderApi {
 public:
  ...
  /// 用户加密登录请求
  virtual int ReqUserLoginEncrypt(
  ...
  /// 期权自对冲录入请求
  virtual int ReqOptionSelfCloseInsert(
      CThostFtdcInputOptionSelfCloseField *pInputOptionSelfClose,
      int nRequestID) = 0;

  /// 期权自对冲操作请求
  virtual int ReqOptionSelfCloseAction(
      CThostFtdcInputOptionSelfCloseActionField *pInputOptionSelfCloseAction,
      int nRequestID) = 0;

  /// 请求核心间资金转移
  virtual int ReqTransFund(CThostFtdcTransFundField *pFtdcTransFund,
                           int nRequestID) = 0;
  ...
  /// 请求查询期权自对冲
  virtual int ReqQryOptionSelfClose(
      CThostFtdcQryOptionSelfCloseField *pQryOptionSelfClose,
      int nRequestID) = 0;
  ...
  /// 请求查询合约状态
  virtual int ReqQryInstrumentStatus(
      CThostFtdcQryInstrumentStatusField *pQryInstrumentStatus,
      int nRequestID) = 0;
